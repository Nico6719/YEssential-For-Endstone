...
default_translations = {
    "zh_CN": {
        ...
        "tpa.settings_on": "§aTPA 已开启（允许接收传送请求）",
        "tpa.settings_off": "§cTPA 已关闭（自动拒绝所有传送请求）",
        "tpa.target_blocked": "§c玩家 %s 已关闭 TPA 接收。",
        "tpa.settings_title": "§6TPA 设置",
        ...
        "notice.admin_title": "§6公告管理",
        "notice.admin_content": "§7选择操作：",
        "notice.del_btn": "§c删除公告",
        "notice.del_title": "§6删除公告",
        "notice.back_btn": "§c返回",
        "notice.no_notice": "§c暂无公告可删除",
        ...
        "back.hour_ago": "%s小时前",
        "back.day_ago": "%s天前",
        "back.deathlog_title": "§6死亡记录",
        "back.deathlog_count": "§7共 %s 条死亡记录",
        "back.deathlog_empty": "§c暂无死亡记录",
        ...
        "cd.server_menu": "服务器菜单",
        "cd.select": "选择:",
        "cd.admin_menu": "管理员菜单",
        "cd.default_menu": "初始菜单",
        "cd.menu_settings": "菜单设置",
        "cd.economy_settings": "经济设置",
        "cd.add_menu": "添加菜单",
        "cd.delete_menu": "删除菜单",
        "cd.modify_menu": "修改菜单",
        "cd.modify_other": "修改其他",
        "cd.select_action": "选择操作:",
        "cd.add_submenu": "添加二级菜单",
        "cd.add_button": "添加菜单按钮",
        "cd.delete_submenu": "删除二级菜单",
        "cd.delete_button": "删除菜单按钮",
        "cd.edit_menu_info": "修改菜单信息",
        "cd.edit_button": "修改菜单按钮",
        "cd.back": "返回上级",
        "cd.config_error": "菜单配置错误",
        "cd.empty_buttons": "菜单按钮为空",
        "cd.button_type_error": "按钮类型错误",
        "cd.op_only": "此功能仅限管理员使用",
        "cd.not_op": "你不是管理员!",
        "cd.no_menu_files": "没有可用的菜单文件",
        "cd.no_menu_available": "无可用的菜单",
        "cd.no_menu_to_delete": "无可删除的菜单",
        "cd.menu_no_buttons": "该菜单没有按钮",
        "cd.add_success": "添加成功",
        "cd.delete_success": "删除成功",
        "cd.delete_fail": "删除失败",
        "cd.edit_success": "修改成功",
        "cd.edit_fail": "修改失败",
        "cd.clock_claimed": "你已经领取过钟表了",
        "cd.clock_fail": "获取钟表失败",
        "cd.clock_success": "已获得钟表，此物品每人仅限领取一次",
        "cd.inventory_full": "背包已满，请清理背包后重试",
        "cd.main_menu_file": "主菜单文件（当前: %s）",
        "cd.no_change": "不修改",
        "cd.set_economy_params": "设置经济参数",
        "cd.select_economy_mode": "选择经济模式",
        "cd.scoreboard": "计分板",
        "cd.input_scoreboard": "输入计分板项",
        "cd.no_operation": "你好像什么都没有操作",
        "cd.file_exists": "文件已存在",
        "cd.invalid_filename": "文件名称不合法",
        "cd.title_command_required": "标题和指令必填",
        "cd.title_content_required": "标题和内容不能为空",
        "cd.menu_title": "菜单标题",
        "cd.menu_content": "菜单内容",
        "cd.select_parent_menu": "选择上级菜单",
        "cd.submenu_filename": "二级菜单文件名称",
        "cd.submenu_title": "二级菜单标题",
        "cd.submenu_content": "二级菜单提示",
        "cd.player_submenu": "玩家二级菜单",
        "cd.admin_submenu": "管理员二级菜单",
        "cd.player_command": "玩家执行指令",
        "cd.admin_command": "管理员执行指令",
        "cd.select_menu_file": "选择菜单文件",
        "cd.select_button_type": "选择按钮类型",
        "cd.button_text": "按钮标题",
        "cd.button_command": "按钮执行指令",
        "cd.button_money": "按钮所需金币",
        "cd.button_position": "按钮位置(0为首)",
        "cd.select_menu_delete": "选择要删除的菜单:",
        "cd.select_menu": "选择菜单:",
        "cd.select_button_delete": "选择要删除的按钮:",
        "cd.select_button_edit": "选择要修改的按钮:",
        "cd.select_menu_edit": "选择要修改的菜单:",
        "cd.menu": "菜单",
        "cd.need_money": "需%s金币",
        "cd.delete_button_title": "删除按钮",
        "cd.edit_menu_title": "修改菜单",
        "cd.edit_button_title": "修改按钮",
        "logo.author": "作者：",
        "logo.version": "版本：",
    ...
    "en_US": {
        ...
        "tpa.settings_on": "§aTPA enabled (accepting requests)",
        "tpa.settings_off": "§cTPA disabled (auto-reject all requests)",
        "tpa.target_blocked": "§cPlayer %s has TPA disabled.",
        "tpa.settings_title": "§6TPA Settings",
        ...
        "cd.server_menu": "Server Menu",
        "cd.select": "Select:",
        "cd.admin_menu": "Admin Menu",
        "cd.default_menu": "Default Menu",
        "cd.menu_settings": "Menu Settings",
        "cd.economy_settings": "Economy Settings",
        "cd.add_menu": "Add Menu",
        "cd.delete_menu": "Delete Menu",
        "cd.modify_menu": "Modify Menu",
        "cd.modify_other": "Other Settings",
        "cd.select_action": "Select action:",
        "cd.add_submenu": "Add Submenu",
        "cd.add_button": "Add Button",
        "cd.delete_submenu": "Delete Submenu",
        "cd.delete_button": "Delete Button",
        "cd.edit_menu_info": "Edit Menu Info",
        "cd.edit_button": "Edit Button",
        "cd.back": "Back",
        "cd.config_error": "Menu config error",
        "cd.empty_buttons": "Menu has no buttons",
        "cd.button_type_error": "Button type error",
        "cd.op_only": "Admin only",
        "cd.not_op": "You are not an admin!",
        "cd.no_menu_files": "No menu files available",
        "cd.no_menu_available": "No menus available",
        "cd.no_menu_to_delete": "No menus to delete",
        "cd.menu_no_buttons": "This menu has no buttons",
        "cd.add_success": "Added successfully",
        "cd.delete_success": "Deleted successfully",
        "cd.delete_fail": "Delete failed",
        "cd.edit_success": "Modified successfully",
        "cd.edit_fail": "Modify failed",
        "cd.clock_claimed": "You have already claimed a clock",
        "cd.clock_fail": "Failed to get clock",
        "cd.clock_success": "Clock obtained, one per player only",
        "cd.inventory_full": "Inventory full, please clear space",
        "cd.main_menu_file": "Main menu file (current: %s)",
        "cd.no_change": "No change",
        "cd.set_economy_params": "Set Economy Params",
        "cd.select_economy_mode": "Select Economy Mode",
        "cd.scoreboard": "Scoreboard",
        "cd.input_scoreboard": "Enter scoreboard name",
        "cd.no_operation": "No changes detected",
        "cd.file_exists": "File already exists",
        "cd.invalid_filename": "Invalid filename",
        "cd.title_command_required": "Title and command required",
        "cd.title_content_required": "Title and content required",
        "cd.menu_title": "Menu Title",
        "cd.menu_content": "Menu Content",
        "cd.select_parent_menu": "Select Parent Menu",
        "cd.submenu_filename": "Submenu filename",
        "cd.submenu_title": "Submenu Title",
        "cd.submenu_content": "Submenu Content",
        "cd.player_submenu": "Player Submenu",
        "cd.admin_submenu": "Admin Submenu",
        "cd.player_command": "Player Command",
        "cd.admin_command": "Admin Command",
        "cd.select_menu_file": "Select Menu File",
        "cd.select_button_type": "Select Button Type",
        "cd.button_text": "Button Text",
        "cd.button_command": "Button Command",
        "cd.button_money": "Button Cost",
        "cd.button_position": "Button Position (0=first)",
        "cd.select_menu_delete": "Select menu to delete:",
        "cd.select_menu": "Select menu:",
        "cd.select_button_delete": "Select button to delete:",
        "cd.select_button_edit": "Select button to edit:",
        "cd.select_menu_edit": "Select menu to edit:",
        "cd.menu": "Menu",
        "cd.need_money": "Cost: %s coins",
        "cd.delete_button_title": "Delete Button",
        "cd.edit_menu_title": "Edit Menu",
        "cd.edit_button_title": "Edit Button",
        "logo.author": "Author: ",
...
class I18n:
    ...
    def _append_missing(self, key: str):
        ...
        # 查找默认翻译值
        value = key
        for loc in (self._locale, "zh_CN", "en_US"):
            dv = default_translations.get(loc, {}).get(key)
            if dv is not None and dv != key:
                value = dv
                break

        # 写入内存
        self._translations.setdefault(self._locale, {})[key] = value
